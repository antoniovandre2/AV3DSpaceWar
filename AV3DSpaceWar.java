    ...
    public void DesenharEspaco(AV3DSpaceWar comp)
        ...
        if (! (Espaco.equals("")))
            ...
            for (i = 0; i < EspacoLinhas.length; i++)
                ...
                if (((ProdutoEscalaro > 0) || ((ProdutoEscalaro < 0) && (Phi % (2 * Math.PI) < Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (Zalvo - z < -MargemDistanciaProdutoEscalarNegativo)) || ((ProdutoEscalaro < 0) && (Phi % (2 * Math.PI) < 3 * Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > 3 * Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (Zalvo - z > MargemDistanciaProdutoEscalarNegativo))) && (Math.abs(Math.acos(ProdutoEscalaro / Math.sqrt(xo * xo + yo * yo + zo * zo))) < AnguloVisao + MargemAnguloVisao) && ((ProdutoEscalard > 0) || ((ProdutoEscalard > 0) || ((ProdutoEscalard < 0) && (Phi % (2 * Math.PI) < Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (Zalvo - z < -MargemDistanciaProdutoEscalarNegativo)) || ((ProdutoEscalard < 0) && (Phi % (2 * Math.PI) < 3 * Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > 3 * Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (Zalvo - z > MargemDistanciaProdutoEscalarNegativo))) || ((ProdutoEscalard < 0) && ((Phi - Math.PI / 2) % Math.PI < 0) && (Zalvo - z > MargemDistanciaProdutoEscalarNegativo))) && ((Math.abs(Math.acos(ProdutoEscalard / Math.sqrt(xd * xd + yd * yd + zd * zd))) < AnguloVisao + MargemAnguloVisao) && (Math.min(xi, Math.min(yi, Math.min(xf, yf))) > 0) && (Math.max(xi + CorrecaoX, xf + CorrecaoX) < TamanhoPlanoX) && (Math.max(yi + CorrecaoY, yf + CorrecaoY) < TamanhoPlanoY)))
    ...
    public void DesenharEspacoDisparo(AV3DSpaceWar comp)
        ...
        if (! (Disparo.equals("")))
            ...
            for (i = 0; i < EspacoLinhas.length; i++)
                ...
                if (((ProdutoEscalaro > 0) || ((ProdutoEscalaro < 0) && (Phi % (2 * Math.PI) < Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (zo - z < -MargemDistanciaProdutoEscalarNegativo)) || ((ProdutoEscalaro < 0) && (Phi % (2 * Math.PI) < 3 * Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > 3 * Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (zo - z > 0))) && (Math.abs(Math.acos(ProdutoEscalaro / Math.sqrt(xo * xo + yo * yo + zo * zo))) < AnguloVisao + MargemAnguloVisao) && ((ProdutoEscalard > 0) || ((ProdutoEscalard < 0) && (Phi % (2 * Math.PI) < Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (zd - z < -MargemDistanciaProdutoEscalarNegativo)) || ((ProdutoEscalard < 0) && (Phi % (2 * Math.PI) < 3 * Math.PI / 2 + MargemPhiProdutoEscalarNegativo) && (Phi % (2 * Math.PI) > 3 * Math.PI / 2 - MargemPhiProdutoEscalarNegativo) && (zd - z > MargemDistanciaProdutoEscalarNegativo))) && ((Math.abs(Math.acos(ProdutoEscalard / Math.sqrt(xd * xd + yd * yd + zd * zd))) < AnguloVisao + MargemAnguloVisao) && (Math.min(xi, Math.min(yi, Math.min(xf, yf))) > 0) && (Math.max(xi + CorrecaoX, xf + CorrecaoX) < TamanhoPlanoX) && (Math.max(yi + CorrecaoY, yf + CorrecaoY) < TamanhoPlanoY)))
                    comp.addLine(xi, yi, xf, yf, CorAlvo);
                }
            }
        }
