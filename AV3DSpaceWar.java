...
public class AV3DSpaceWar extends JComponent
	...
	public static double LimiteXdisparo = 2000; // Default: 2000.
	public static double LimiteYdisparo = 2000; // Default: 2000.
	public static double LimiteZdisparo = 2000; // Default: 2000.
	...
	public void DesenharEspacoDisparo(AV3DSpaceWar comp)
		...
		if (! (Disparo.equals("")))
			{
			String [] EspacoLinhas = Disparo.split("\\|");
